...
def build_lesson_prompt(user_id: int, folder_name: str) -> str | None:
    ...
    try:
        ...
        prompt += (
            ...
            "6. After teaching the key concepts, ask 1-2 questions to check understanding. These should be "
            "answerable PURELY from what you just taught — the student should not need to look anything up.\n"
            ...
            "8. When the student answers correctly, congratulate them and ask if they're ready for the next section.\n"
            "9. NEVER claim you don't have access to the student's uploaded documents. The relevant content is provided below.\n"
            "10. When you believe the student has understood the section, include the exact phrase "
